...
//console.log(reduce(sourceArray55, function(e, memo){return e + memo}, 100)); 
//console.log(reduce(sourceArray55, function(e, memo){return e + memo})); 

//console.log(reduce(sourceArray6, function(a, memo){ return !!a && !!memo}));
